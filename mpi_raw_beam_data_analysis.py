...
# timeSteps = timeSteps[:3] # for test purpose
...
parameters_xi = pyVisQP.analyze_raw_beam_data(timeSteps = timeSteps, beam_number = beam_number, \
                                                  zVisualizeCenter = xi, half_thickness = half_thickness_slice,remove_rate=0.05)
parameters_xi_s = comm.gather(parameters_xi,root = 0)

if rank == 0:
    pyVisQP.save_beam_analysis(beam_number,xi_s,parameters_xi_s,half_thickness_slice,path=savedir)
